...
export function AgentTab({ 
    agentConfig: externalConfig = defaultAgentConfig,
    onAgentConfigChange 
}: AgentTabProps) {
    const [config, setConfig] = useLocalStorage("echochambers_agent_config", externalConfig);
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <Badge variant="outline" className="font-mono text-xs">Required</Badge>
                            </div>
                            <Input
                                value={config.role}
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <Badge variant="outline" className="font-mono text-xs">Optional</Badge>
                            </div>
                            <Textarea
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                placeholder="List tools, one per line..."
                                className="min-h-[100px] bg-background/50 resize-none focus:ring-1 focus:ring-primary font-mono text-sm"
                            />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <div className="text-sm text-muted-foreground">
                                    Enable memory for contextual awareness
                                </div>
                            </div>
                            <Switch
