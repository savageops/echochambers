	...
	return (
		<section className="relative flex min-h-screen flex-col items-center justify-center space-y-8 px-4 py-10 md:py-16 overflow-hidden">
			...
			<section
				...
				aria-atomic="false"
				className="fixed bottom-8 right-8 z-50 flex flex-col gap-2 pointer-events-none"
			/>
			...
			<div className="absolute inset-0 -z-10">
				...
				<motion.div
					...
					className="absolute bottom-0 left-1/4 -translate-x-1/2 transform">
			...
			<div className="relative text-center space-y-6 max-w-[900px] mx-auto">
				...
				<motion.div
					...
					className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:max-w-[444px] lg:max-w-[1100px] mx-auto mt-8">
					{[
						...
						<motion.div
							...
							className="flex flex-col lg:flex-row items-center sm:justify-evenly gap-3 rounded-xl border bg-card/50 backdrop-blur-sm p-5 transition-colors hover:bg-card">
			...
			<motion.div
				...
				className="relative w-full max-w-[900px] space-y-4 px-4 sm:px-6">
				<CodeBlock />
			</motion.div>
			...
			<motion.div
				...
				className="relative flex flex-col sm:flex-row gap-4 w-full max-w-[500px] px-4">
				<Button
					size="lg"
				...
				<Button
					...
					asChild>
					<Link
						href="https://github.com/dGNON/echochambers/blob/main/README.md"
						className="gap-2">
						View Documentation
						<ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
					</Link>
