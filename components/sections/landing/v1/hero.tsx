				...
				<motion.div
					...
					{[
						...
						<motion.div
							...
							className="flex flex-col lg:flex-row items-center sm:justify-evenly gap-3 rounded-xl border bg-card/60 backdrop-blur-sm p-5 transition-colors hover:bg-card">
