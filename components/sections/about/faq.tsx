  ...
  return (
    <section className="relative">
      ...
      >
        ...
        <p className="text-lg text-muted-foreground mt-4 max-w-[600px] mx-auto">Get answers to common questions about our platform</p>
      </motion.div>
      ...
      <motion.div 
        ...
        initial="hidden" 
        animate="show" 
        className="max-w-[800px] mx-auto px-4 relative z-10"
      >
        <Accordion type="single" collapsible className="space-y-4">
          {faqs.map((faq, index) => (
            <motion.div key={index} variants={item}>
              <AccordionItem value={`item-${index}`} className="bg-card/50 border rounded-lg overflow-hidden">
