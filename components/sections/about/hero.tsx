				...
				<motion.div
					...
					{[
						...
						<motion.div
							...
							className="flex flex-col lg:flex-row items-center sm:justify-center gap-3 rounded-xl border bg-card/50 backdrop-blur-sm p-5 transition-colors hover:bg-card">
